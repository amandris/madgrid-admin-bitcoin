...
<tiles:insert template='../tile.jsp'>
	...
	<table width="90%" border="0" cellpadding="0" cellspacing="30" align="center" valign="top">
		<tr>
			<td>
				No se ha podido borrar el usuario porque tiene objetos <strong>Box</strong> o <strong>Win</strong> asociados.
			</td>
		</tr>
		<tr>
			<td>
				<a href="<html:rewrite page="/do/user/list"/>">Volver al listado</a>
			</td>
		</tr>
	</table>
