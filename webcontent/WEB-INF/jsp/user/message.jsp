...
<tiles:insert template='../tile.jsp'>
	...
	<span style="font-family:Arial;font-size:18px;">Enviar mensaje a usuario</span>

	<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" valign="top">
		<tr>
			<td align="center">
				<html:form action="/user/messageSend">
					...
					<table width="70%" class="tab">
						<tr>
							...
							<td>
								<c:out value="${user.login}"/> (<c:out value="${user.email}"/>)
							</td>
						</tr>
						<tr>
							<td>
