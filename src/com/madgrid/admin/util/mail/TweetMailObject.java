...
public class TweetMailObject implements MailObject {

	private String 	baseUrl; 
	private String 	login;
	
	
	public TweetMailObject( String login, String baseUrl)
	{
		this.login = login;
	...
	public String toHtml()
	{
		...
		result.append( "                <p>As we promised we've just add one credit to your account. You can use it right now in any game.<br/><br/>Thank you for playing in Instantri.ch and tweeting about it.</p>");
	...
	public String toText()
	{
		...
		result.append( "As we promised we've just add one credit to your account. You can use it right now in any game.Thank you for playing in Instantri.ch and tweeting about it.\r\n");
