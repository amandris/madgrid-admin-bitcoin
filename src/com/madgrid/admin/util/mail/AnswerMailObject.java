...
public class AnswerMailObject implements MailObject {
	...
	public AnswerMailObject( String originalMessage, String message, String login, String baseUrl)
	{
	...
	public String toHtml()
	{
		...
		if( login != null){
			...
			result.append( "                <h1 style='font-size:24px;'>Hello!</h1>");
		}
		result.append( "                <p>"+message+"</p>");
		result.append( "                <p>-----Original message</p>");
		result.append( "                <p>"+originalMessage+"</p>");
